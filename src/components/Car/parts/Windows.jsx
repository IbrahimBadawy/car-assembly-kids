...
export default function Windows() {
  ...
  return (
    <group>
      {/* Left windows */}
      <mesh position={[-1.02, 0.55, -0.3]} castShadow raycast={isXray ? noopRaycast : defaultRaycast}>
        <boxGeometry args={[0.04, 0.45, 0.55]} />
        <meshStandardMaterial color="#00CED1" transparent opacity={opacity} roughness={0.1} metalness={0.1} />
      </mesh>
      <mesh position={[-1.02, 0.55, 0.4]} castShadow raycast={isXray ? noopRaycast : defaultRaycast}>
        <boxGeometry args={[0.04, 0.45, 0.55]} />
        <meshStandardMaterial color="#00CED1" transparent opacity={opacity} roughness={0.1} metalness={0.1} />
      </mesh>
      ...
      {/* Windshield */}
      <mesh position={[0, 0.6, -1.05]} rotation={[0.3, 0, 0]} castShadow raycast={isXray ? noopRaycast : defaultRaycast}>
      ...
      {/* Rear window */}
      <mesh position={[0, 0.6, 1.1]} rotation={[-0.3, 0, 0]} castShadow raycast={isXray ? noopRaycast : defaultRaycast}>
